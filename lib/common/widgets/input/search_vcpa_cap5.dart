...
class SearchVCPACap5 extends StatefulWidget {
  const SearchVCPACap5({
    super.key,
  ...
  @override
  State<SearchVCPACap5> createState() => _SearchVCPACap5State();
}

class _SearchVCPACap5State extends State<SearchVCPACap5> {
  late Iterable<TableCTDmNhomNganhVcpa> fitlerResult =
            ...
            child: Container(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  final TableCTDmNhomNganhVcpa option =
                      options.elementAt(index);
                  String title = option.moTaNganhSanPham!;
                  String subTitle = 'Cấp 1: ${option.cap1}';
                  return Column(
                    children: [
                      GestureDetector(
                        onTap: () {
