...
class DialogCompletedQuestion extends StatefulWidget {
  ...
  @override
  State<DialogCompletedQuestion> createState() =>
      _DialogCompletedQuestionState();
}

class _DialogCompletedQuestionState extends State<DialogCompletedQuestion> {
  ...
  Widget _buttonContent() {
    ...
    return ElevatedButton(
        onPressed: _getLatLng, child: const Text('Lấy tọa độ'),
       style: ButtonStyle(
