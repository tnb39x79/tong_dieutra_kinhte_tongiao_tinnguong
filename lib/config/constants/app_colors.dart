...
const Color primaryColor = Color(0xFFDC9874);// Color.fromARGB(255,248, 165, 1);//Color(0xFFF8A501); //Color.fromARGB(255, 209, 141, 5);// Color(0xFFF8A501);
...
//
const Color primaryColorMenuIcon =  Color(0xFFFFC107);
// satus color
...
const Color greyBulliet = Color.fromARGB(255, 229, 231, 233);
