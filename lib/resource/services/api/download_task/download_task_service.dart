...
class DownloadTaskService {
  ...
  /// Static method to fire file downloading returns future of [DownloadTaskService] which may be used to control the request
  ///
  ...
  ///
  static Future<DownloadTaskService> download(
    Uri url, {
    ...
    final task = DownloadTaskService._(
        url: url,
        headers: headers,
